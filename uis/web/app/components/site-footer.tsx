...
export function SiteFooter({ locale, text, nav, footerNavTitle, footerFollowTitle, footerPrivacyLabel }: SiteFooterProps) {
  return (
    <footer className="w-full py-16 md:py-24 px-6 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 bg-background border-t border-white/10 opacity-80 hover:opacity-100 transition-opacity">
      ...
      <div className="col-span-1 flex flex-col gap-6" aria-label={footerFollowTitle}>
        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-4">
          <a
            aria-label="Facebook"
            className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-text-dim hover:text-primary hover:border-primary transition-colors"
          ...
          <a aria-label="Sketchfab" className="text-text-dim hover:text-primary transition-colors text-sm font-medium" href="https://sketchfab.com/3dcosprops">Sketchfab</a>
          <a aria-label="ArtStation" className="text-text-dim hover:text-primary transition-colors text-sm font-medium" href="https://www.artstation.com/3dcosprops">ArtStation</a>
          <a aria-label="YouTube" className="text-text-dim hover:text-primary transition-colors text-sm font-medium" href="https://www.youtube.com/@3DCosProps">YouTube</a>
        </div>
      </div>
    </footer>
  );
